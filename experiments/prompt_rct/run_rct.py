...
def get_batch_api_keys(cfg):
    ...
    return apply_batch_key_override(get_api_keys(cfg), current_app.config)
...
# batch_submit / batch_check_and_collect / _convert_messages_for_anthropic
# now live in backend/utils/llm_batch.py (imported above) — single source
# of truth shared with the production profile-batch pipeline.
