...
> **State sync (2026-06-29) — stale-issue close-out:** closed completed — **#179, #139, #65, #32, #173, #89, #190**; **#140** set to auto-close via PR #206 (fix on `feat/145-tts-chapters`). Kept open with documented gaps — **#105** (the `stripProposalTag()` stripper is not applied to the completed/newTasks/priority bodies or surrounding prose — the "no longer reproduces" read was wrong), **#78** (in-app SPA nav during recording still unguarded), **#155** (RAG umbrella; Community-Archive parts still live; follow-ups #221/#223). Authoritative refs in **PLAN Section 0, 2026-06-29 snapshot**.
>
