...
8b. **PoC (2026-09-13):** Community Archive personal feed — A.26; judge the picks over a few mornings, then decide whether to build the nightly job (snapshot refresh + batch + a feed surface) or drop it
