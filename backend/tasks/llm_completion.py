...
VOICE_TOOLS = [
    {
        ...
        "description": (
            ...
            "priorities. Importantly, your text response must use the "
            "exact heading structure with ### Completed, ### New Tasks, "
            "### Priority Order, and/or ### Note sections. The system "
            "parses these headings to detect changes — without them, "
            "the proposal is silently lost. The reverse also applies: "
            "every response containing these headings must include a "
            "call to this tool — even revised or corrected proposals. "
            "Each response needs its own tool call. Omit sections that have no "
